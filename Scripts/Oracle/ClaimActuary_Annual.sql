...
100000000000007308))) HDR))CHDR) WHERE PAYMENTREFNO NOT IN (SELECT A.PAYMENTREFNO FROM IM_CLAIM_ACTUARY A) AND
(TO_DATE(PAY_DATE,'DD/MM/RRRR') >  To_Date('01/01/2016','DD/MM/RRRR')  OR 
TO_DATE(REVERSEREFDATE,'DD/MM/RRRR') >  To_Date('01/01/2016','DD/MM/RRRR'))) 